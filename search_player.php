...
//var_dump($my_player_list);

//list to ,"value", "value", "value"
$js_list = "";
foreach ($my_player_list as $player) {
	$js_list .= ',{label: "'.$player->player_name.'", value:"'.$player->id.'"}';
    //$js_list .= ',"'.$player->player_name.'"';
}
   
 $js_list = substr($js_list, 1);
 
 //$js_list = ' { label: "Dwayne", value: "123" }, {label : "Erica", value: "345"} ';
...
<header class="header"> <a href="#" class="header__icon" id="header__icon"></a> <a href="#" class="header__logo"><img style="max-width:160px; margin-top: -7px;" src="img/statlogo.png"></a>
  <nav class="menu"> <a href="index.html">Home</a> <a href="search_player.php">Player Stat</a> <a href="search_teams.php">Team Stat</a> <a href="search_comparison.php">Comparision</a> </nav>
  </div>
  </div>
</header>
<div class="ui-widget">
...
<script>
  $(function() {
	...
	$( "#tags" ).on( "autocompleteselect", function( event, ui ) {
		window.location.replace("playerstats.php?id=" + ui.item.value)
	} );
